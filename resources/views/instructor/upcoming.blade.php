    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div
                    class="p-6 text-gray-900 dark:text-gray-100 max-w-2xl divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    @empty
                        <div>
                            <p class="text-gray-800 dark:text-gray-200">You don't have any upcoming classes</p>
                            <a class="inline-block mt-6 underline text-sm text-gray-800 dark:text-gray-200"
